    ...
    <div class="flex flex-row w-full ">
        ...
        <div class="content flex flex-col flex-auto">
            ...
            <div class="grid grid-cols-4 justify-items-center pl-[15%] pr-[15%] pt-10">
                ...
                <?php echo $__env->make('components.smallcourseitem', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('components.smallcourseitem', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->make('components.smallcourseitem', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="card-body overflow-hidden green rounded-b-2xl">
                            ...
                            <div class="card-actions justify-start mt-3">
                                <div class="avatar-group -space-x-6 rtl:space-x-reverse">
                                    ...
                                    <div class="avatar">
                                        <div class="w-8">
                                            <img src="<?php echo e(asset('assets/nanachipfp.jpg')); ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
</html><?php /**PATH C:\Users\NITRO\Desktop\WebFund\LS_docker\WebPro-Project__LearnSite__\WebPro-Project__LearnSite__\src\resources\views/instructorhome.blade.php ENDPATH**/ ?>