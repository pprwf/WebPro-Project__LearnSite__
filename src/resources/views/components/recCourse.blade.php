...
@endforeach
        ...
        <script>
            ...
            function disable_pointer(element_id) {
                document.getElementById(element_id).style.pointerEvents = "none";
            }

            function enable_all_pointer() {
                document.getElementById("btn-rc-l").style.pointerEvents = "auto";
                document.getElementById("btn-rc-r").style.pointerEvents = "auto";
            }
            ...
            function changeOrderToRight() {
                ...
                if (beforeClickOrder >= maxRecCourse - 1) {
                    disable_pointer("btn-rc-r");
                }
            }
        </script>
